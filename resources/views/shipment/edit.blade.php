...
<main class="content">
    <div class="container-fluid p-0">
        ...
        <div class="mb-3">
            <h1 class="h3 d-inline align-middle">Edit Shipment </h1>
            ...
            <div class="col-12 col-xl-6">
                <div class="card">
                    <div class="card-header">
                        ...
                        <h6 class="card-subtitle text-muted">Edit Shipment</h6>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('shipments.update', $shipment->id) }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" name="delivery_date"  required value="{{ old('date', $shipment->delivery_date) }}">
                            </div>
                            <div class="mb-3">
